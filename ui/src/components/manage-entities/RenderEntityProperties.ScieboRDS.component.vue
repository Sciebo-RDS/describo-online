<template>
    <div class="flex flex-col space-y-2 divide-y divide-slate-500">
        <div
            ...
            :class="{
                'border-l-8 !border-l-[#bada55] my-1': update.success === name,
                'bg-red-100 my-1 rounded': update.erro === name,
            }"
        >
...
<script>
import RenderEntityPropertyDataComponent from "./RenderEntityPropertyData.ScieboRDS.component.vue";
